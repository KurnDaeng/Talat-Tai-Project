...
window.TALAT_TAI_TRANSLATIONS = {
  en: {
    ...
    customerLoginTitle: "Enter your details to shop",
    customerLoginBody:
      "Enter your name and phone number so your orders stay connected to you.",
    customerLoginButton: "Enter the store",
    customerLoginNote: "Your details are saved on this device to label your orders.",
    ...
    orderReceiptLabel: "Payment slip",
    deliveryLabel: "Delivery",
    fulfillPreparing: "Preparing",
    fulfillPacked: "Packed",
    fulfillShipped: "On the way",
    fulfillDelivered: "Delivered",
    fulfillCancelled: "Cancelled",
  ...
  th: {
    ...
    customerLoginTitle: "กรอกข้อมูลก่อนเลือกซื้อ",
    customerLoginBody: "กรอกชื่อและเบอร์โทรศัพท์เพื่อเชื่อมคำสั่งซื้อกับคุณ",
    customerLoginButton: "เข้าสู่ร้าน",
    customerLoginNote: "ข้อมูลของคุณถูกบันทึกไว้ในเครื่องนี้เพื่อระบุคำสั่งซื้อ",
    ...
    promoPlaceholder: "โค้ดส่วนลด",
    promoApply: "ใช้",
    promoApplied: "ใช้โค้ดส่วนลดแล้ว",
    promoInvalid: "โค้ดไม่ถูกต้อง",
    ...
    orderReceiptLabel: "สลิปการชำระเงิน",
    deliveryLabel: "การจัดส่ง",
    fulfillPreparing: "กำลังเตรียม",
    fulfillPacked: "แพ็กแล้ว",
    fulfillShipped: "กำลังจัดส่ง",
    fulfillDelivered: "จัดส่งแล้ว",
    fulfillCancelled: "ยกเลิก",
  ...
  mm: {
    ...
    customerLoginTitle: "ဈေးဝယ်ရန် အချက်အလက် ဖြည့်ပါ",
    customerLoginBody: "မှာယူမှုများကို ချိတ်ဆက်ရန် အမည်နှင့် ဖုန်းနံပါတ် ထည့်ပါ။",
    customerLoginButton: "ဆိုင်ထဲ ဝင်ရန်",
    customerLoginNote: "သင့်အချက်အလက်ကို အော်ဒါများ မှတ်သားရန် ဤစက်ထဲတွင်သာ သိမ်းပါသည်။",
    ...
    promoPlaceholder: "ပရိုမိုကုဒ်",
    promoApply: "သုံးရန်",
    promoApplied: "ပရိုမို သက်ရောက်ပြီး",
    promoInvalid: "ပရိုမိုကုဒ် မမှန်ပါ",
    ...
    addToCartButton: "ဈေးခြင်းထဲ ထည့်ရန်",
    ...
    orderReceiptLabel: "ငွေလွှဲပြေစာ",
    deliveryLabel: "ပို့ဆောင်မှု",
    fulfillPreparing: "ပြင်ဆင်နေသည်",
    fulfillPacked: "ထုပ်ပိုးပြီး",
    fulfillShipped: "လမ်းမှာ ပို့နေသည်",
    fulfillDelivered: "ပို့ဆောင်ပြီး",
    fulfillCancelled: "ပယ်ဖျက်ပြီး",
...
window.TALAT_TAI_TEXT_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "homeBanner", label: "Home promo banner (blank = hidden)", type: "textarea" },
      ...
      { key: "orderReceiptLabel", label: "Orders: payment slip label", type: "input" },
      { key: "deliveryLabel", label: "Orders: delivery label", type: "input" },
      { key: "fulfillPreparing", label: "Delivery: preparing", type: "input" },
      { key: "fulfillPacked", label: "Delivery: packed", type: "input" },
      { key: "fulfillShipped", label: "Delivery: on the way", type: "input" },
      { key: "fulfillDelivered", label: "Delivery: delivered", type: "input" },
      { key: "fulfillCancelled", label: "Delivery: cancelled", type: "input" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "discountLabel", label: "Discount label", type: "input" },
      { key: "promoPlaceholder", label: "Promo input placeholder", type: "input" },
      { key: "promoApply", label: "Promo apply button", type: "input" },
      { key: "promoApplied", label: "Promo applied message", type: "input" },
      { key: "promoInvalid", label: "Promo invalid message", type: "input" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "addToCartButton", label: "Add to cart button", type: "input" },
